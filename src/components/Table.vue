<template>
  <MaterialCard
    ...
    :text="`Total no of desserts: ${tableItems.length}`"
  >
    <!-- Card Tabs -->
    <v-tabs
      v-model="active"
        ...
        <v-card flat>
          <v-card-text>
            ...
            >
              ...
              <v-card>
                <v-card-title>
                  <span class="headline">{{ editedIndex === -1 ? 'Add New Product' : editedIndex === -2 ? 'Copy Product' :'Edit Product' }}</span>
                </v-card-title>
                ...
                <v-card-text>
                  <v-container grid-list-md>
                    <v-layout wrap>
                      <v-flex
                        v-for="(value, name) in editedItem"
                        :key="name"
                        xs12
                        sm6
                        md4
